...
# Load the model
model_path = 'C:\\Users\\user\\Desktop\\AUB\\Semesters\\Summer 2024\\Healthcare Analytics\\Group Project\\random_forest_model.pkl'
...
ethnicity = st.selectbox('Ethnicity', [0, 1, 2, 3], format_func=lambda x: ['Ethnicity 0', 'Ethnicity 1', 'Ethnicity 2', 'Ethnicity 3'][x])
...
alcohol_consumption = st.number_input('Alcohol Consumption', min_value=0.0, max_value=20.0, value=10.0)
...
cholesterol_total = st.number_input('Total Cholesterol', min_value=150.0, max_value=300.0, value=200.0)
cholesterol_ldl = st.number_input('LDL Cholesterol', min_value=50.0, max_value=200.0, value=100.0)
cholesterol_hdl = st.number_input('HDL Cholesterol', min_value=20.0, max_value=100.0, value=60.0)
cholesterol_triglycerides = st.number_input('Triglycerides', min_value=50.0, max_value=400.0, value=150.0)
